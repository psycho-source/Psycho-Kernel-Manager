...
import com.psychomods.updater.DownloadBarFragment;
import com.psychomods.updater.DownloadReceiver;
import com.psychomods.updater.jollakernelUpdaterActivity;
import com.psychomods.updater.R;
...
public abstract class BaseInfo implements Parcelable, Serializable {
    ...
    public void showUpdateNotif(Context ctx) {
        ...
        Intent mainIntent = new Intent(ctx, jollakernelUpdaterActivity.class);
