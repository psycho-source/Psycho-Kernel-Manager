...
import com.psychomods.updater.utils.DownloadStatus;

import static android.support.v4.content.PermissionChecker.checkSelfPermission;

public class DownloadReceiver extends BroadcastReceiver {
    public static final String DL_KERNEL_ACTION = "com.psychomods.updater.action.DL_KERNEL_ACTION";

    public static final String CLEAR_DL_ACTION = "com.psychomods.updater.action.CLEAR_DL_ACTION";
